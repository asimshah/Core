...
namespace Fastnet.Core.Cron
{
    ...
    public sealed class CrontabSchedule
    {
        ...
        /// <summary>
        /// use to enable six-part expressions (which include seconds)
        /// </summary>
        [Serializable]
        public sealed class ParseOptions
        {
            /// <summary>
            /// set to enable seconds
            /// </summary>
        ...
        // 
        /// <summary>
        /// Parse string into CrontableSchedule
        /// </summary>
        /// <remarks>
        /// * * * * *
        /// - - - - -
        ...
        ///
        /// </remarks>
        /// <param name="expression">five or six part expression see options)</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="expression">five or six part expression see options)</param>
        /// <param name="options">true for a six-part expression (including seconds)</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get natural language description of schedule
        /// </summary>
        /// <param name="expression"></param>
        /// <returns></returns>
